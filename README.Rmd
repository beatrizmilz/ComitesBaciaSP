...
Para utilizar as funções do pacote, primeiramente é necessário saber a sigla referente ao comitê que você deseja buscar informações. A base comites_sp disponibiliza esta informação:
